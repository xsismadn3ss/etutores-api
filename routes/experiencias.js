...
//   validatePermissions(["administrador"]),
  experienciaController.getExperiencias
);
router.get(
  "/experiencia/:id",
//   validatePermissions(["administrador"]),
  experienciaController.getExperiencia
);
router.post(
  "/experiencia",
//   validatePermissions(["administrador"]),
...
// rutas para profesor
router.get(
  "/profesor/experiencias/",
//   validatePermissions(["profesor", "administrador"]),
  experienciaController.getProfesorExperience
);
router.post(
  "/profesor/experiencias/",
//   validatePermissions(["profesor", "administrador"]),
  experienciaController.createProfesorExperience
);
router.put(
  "/profesor/experiencias/:id",
//   validatePermissions(["profesor", "administrador"]),
  experienciaController.updateProfesorExperience
);
router.delete(
  "/profesor/experiencias/:id",
//   validatePermissions(["profesor", "administrador"]),
  experienciaController.deleteProfesorExperience
);
